...
# Version : v1
# Date 05/08/2023
# info : AWS S3 Notification trigger
# Description : Whenever the user uploads a file to the S3 bucket this script will automatically send an email to the below mentioned email id.
# Prerequisites : AWS CLI, jq, zip
...
bucket_name="pratik-s3-trigger"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="pratikks01.dev@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Pratik Shastrakar, This is my first shell scripting project with AWS"
